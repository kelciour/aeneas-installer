...
Filename: "{app}\[PYTHON_FILE]"; Parameters: "/PASSIVE InstallAllUsers=1 TargetDir=C:\Python37-64 PrependPath=1"; Description: "Install Python [PYTHON_VER]"; Components: python; Flags: shellexec waituntilterminated
